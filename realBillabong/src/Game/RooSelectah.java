...
public class RooSelectah implements MouseListener {
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (Main.getState().getLoop().getBoard().getBoardArray()[actualY][actualX].isOccupied() ){
			if(Main.getState().getLoop().getBoard().getBoardArray()[actualY][actualX].getIsHere().getTeam() == Main.getState().getLoop().getCurrentPlayer().getColor()){
				selected = Main.getState().getLoop().getBoard().getBoardArray()[actualY][actualX].getIsHere() ;
				done = true ;
			}
		}
	...
	public Kangaroo getSelected() {
		return selected;
	}

	public void setSelected(Kangaroo selected) {
